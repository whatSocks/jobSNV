...
- *user interestes*: (I search for 'butterflies' on Amazon.com while logged into Facebook and am then presented with lepidopterae-related ads across Facebook)
...
We can take several paths to generate recommended groups for companies to advertise in:
